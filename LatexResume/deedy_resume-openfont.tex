...
\namesection{John}{McCormack}{ \urlstyle{same}\url{http://jdmccormack.com} \\
\href{mailto:mccormack.wgsi@gmail.com}{mccormack.wgsi@gmail.com} | 617.257.5586
}
...
\subsection{Florida Polytechnic University}
\descript{Masters of Engineering}
\location{Expected May 2016 | Lakeland, FL \\ GPA 4.0}
\sectionsep

\subsection{University of California, Irvine}
\descript{Certificate in Embedded Systems Engineering}
\location{Sep 2014 | Irvine, CA}
\location{GPA: 3.7} \\
\sectionsep

\subsection{UMASS Lowell}
\descript{B.S. In Electrical Engineering}
\location{Minor in Sound Recording Technology}
\location{Grad. May 2012 |  Lowell, MA}
\location{Graduated Magna Cum Laude}
\sectionsep
...
\section{Links} 
Github:// \href{https://github.com/jmccormack200}{\custombold{jmccormack200}} \\
LinkedIn://  \href{https://www.linkedin.com/in/jdmccormack}{\custombold{jdmccormack}} \\
\sectionsep
...
MATLAB \location{Learning}  \textbullet{} C++ \textbullet{} Rust
\sectionsep
